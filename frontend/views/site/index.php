                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 text-right">
                                <div class="big-tagline">
                                    <h2><strong>MAKTAB </strong>BILIM MASKANI!</h2>
                                    <p class="lead">Assalomu alaykum, Xush kelibsiz!!! </p>
                                    <a href="#" class="hover-btn-new"><span>Maktabimiz haqida qisqacha</span></a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="#" class="hover-btn-new"><span>Me'yoriy hujjatlar</span></a>
                                </div>
                            </div>
                        </div><!-- end row -->
                    </div><!-- end container -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 text-left">
                                <div class="big-tagline">
                                    <h2 data-animation="animated zoomInRight">a'lochi o'quvchilar <strong>maktabning ko'zgusi</strong></h2>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 text-center">
                                <div class="big-tagline">
                                    <h2 data-animation="animated zoomInRight"><strong>Bizning faxrimiz,</strong>Bizning qaldirg'ochlarimiz</h2>
